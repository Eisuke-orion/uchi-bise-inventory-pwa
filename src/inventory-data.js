...
export const INITIAL_PRODUCTS = [
  ...
  ['ハンドペーパー','消耗品','ドラッグストア','袋',2,1,15],
  ['ティッシュペーパー 袋（5パック）','消耗品','ドラッグストア','袋',1,2,8],
  ['トイレットペーパー 袋（12ロール）','消耗品','ドラッグストア','袋',1,2,1],
  ['手袋','消耗品','みつわ','箱',1,3,2],
  ['コップ','消耗品','みつわ','個',100,500,400],
  ['蓋','消耗品','みつわ','個',100,500,300],
...
export const STOCK_SNAPSHOT_AT = '2026-08-10T17:00:00+09:00';
export const STOCK_SNAPSHOT_EDITOR = '仲本 理七、東原 萌';
